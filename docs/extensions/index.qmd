...
@usingany CairoMakie, Meshes, LazyGrids
```
...
fig_deformed = viz_mesh(SimpleMesh(dpoints, mesh.topology.connec), color = color_data, colormap = :jet1, alpha = 1., zlim = (-0.15, 0.15), title = "Deformed mesh of the plate")
```
