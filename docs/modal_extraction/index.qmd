...
1. **Identification of natural frequencies**
    ...
    To check the peak detection, one can use the `peaksplot` function from `StructuralVibration.jl` (see [Peaks plot](../extensions/index.qmd#peaks-plot) for more details).
