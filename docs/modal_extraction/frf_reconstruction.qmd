...
#| echo: false
fig = Figure()
ax = Axis(fig[1, 1], xlabel = "Frequency (Hz)", ylabel = "Admittance (dB, ref: 1 N/m)", title = "FRF Reconstruction using Sdof method")
...
#| echo: false
fig1 = Figure()
ax1 = Axis(fig1[1, 1], xlabel = "Frequency (Hz)", ylabel = "Admittance (dB, ref: 1 N/m)", title = "FRF Reconstruction using Mdof method")
