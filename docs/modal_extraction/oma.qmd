...
Once the mode shapes are extracted, the FSDD utilizes the unitary property of the singular vectors to derive an enhanced output PSD $\hat{G}_{yy}(\omega)$ in the vicinity of the resonance frequency, such that:
$$
