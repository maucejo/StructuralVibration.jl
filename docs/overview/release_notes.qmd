...
- Modal extraction
  - Add `LSFit()` method for modal parameter extraction using least squares fitting of the frequency response function around the resonance peaks.
  - Add `AutoEMASdofProblem` structure and `solve` function to perform automatic modal extraction based on Sdof approximations.
  - Add Mdof methods for modal parameter extraction:
    ...
    - `stabilization` function to perform stabilization diagram analysis using Mdof methods
