...
- Modal extraction
  ...
  - Add `OMAMdofProblem` structure to perform Operational Modal Analysis (OMA) using half-spectrum data
  - Add `halfspec_reconstruction` function to reconstruct half-spectrum from extracted modal parameters
