...
ωₙ, kₙ = modefreq(bar, fmax)

# Computation of the corresponding mode shapes
ϕₙ = modeshape(bar, kₙ, x, :CC)
```
...
Kmodal, Mmodal, Cmodal = modal_matrices(ωₙ, 0.01)

# Computation of modal effective mass
meff = modal_effective_mass(M_bc, Φₙ, ones(2))
```
